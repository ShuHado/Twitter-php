...
<body>
      ...
      <div class="center" id="profil">
            <div>
                  <img class="banniere-profil" src="<?php echo $user_data['photo_back_profile'] ?>" alt="Bannière profil">
                  <img class="image-profil profil" src="<?php echo $user_data['photo_profile'] ?>" alt="photo de profil">
            </div>

            <div class="info">
                  <div>
                        <h3 class="profile_name"><?php echo $user_data['name']; ?></h3>
                        <h3 class="user"><?php echo $user_data['tag']; ?></h3>
                  </div>
                  <button>
                        <h3>Suivre</h3>
                  </button>
            </div>
            <h3 class="description"><?php echo $user_data['description']; ?></h3>
            <div class="about">
                  <div class="ville">
                  ...
                  <div class="inscription">
                        ...
                        <p>A rejoint Twitter le <?php echo $user_data['date_inscription']; ?></p>
                  </div>
            </div>
            <div class="follower-followee">
                  <div class="follower">
                        <h3><?php echo $user_data['nb_abonnements']; ?></h3>
                        <p class="follower">abonnements</p>
                  </div>
                  <div class="followee">
                        <h3><?php echo $user_data['nb_abonnes']; ?></h3>
