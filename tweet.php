...
if (isset($_POST["message"])) {
      ...
      $query = "INSERT INTO posts(message,date,post_id,user_id) VALUES (:message,CURRENT_TIME,:post_id,:user_id);";
      try {
            // préparation de la requête et exécution
            $q = $db->prepare($query);
            // ça permet de remplacer les variables présents dans la requête SQL (précédées par le symbole ':')
...
<body>
      <div class="center">
            <div class="tweet">
                  <div class="profile">
                        <img class="image-profil" src="src/squeezie.jpg" alt="Squeezie">
                  </div>
                  <div class="tweet-right">
                        <header>
                              <h3>Alexandre Nicolas</h3>
                        ...
                        <h3 class="user">@alexandrenicolas</h3>
                        <p class="message">
                              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. In dictum non consectetur a erat nam.
                        </p>
                        <div class="time-date">
                              <h3 class="time">5h PM</h3>
                              <h3 class="dot">·</h3>
                              <h3 class="date">2 fevr. 2022</h3>
                        </div>
                        <div class="likes">
                              <h3>98</h3>
                              <p>j'aime</p>
            ...
            <form id="form" class="formulaire" action="index.php" method="post">
                  <img src="src/jdg.png" alt="Joueur du Grenier">
